...
const Contact = () => {
  ...
  return (
    <>
      <div
        className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-6 p-6 bg-gradient-to-b from-[#E7FFFE] to-[#F2FDFF] dark:bg-gradient-to-b dark:from-primary/5 dark:to-primary/2
